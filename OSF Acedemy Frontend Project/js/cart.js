...
// Find items box
const itemBox = document.querySelector("section.payment div.items");
...
// Amount select ..............................
let amount = document.querySelectorAll("section.payment div.cart-wrapper div.items div.item div.amountpick > input");
let minus = document.querySelectorAll("section.payment div.cart-wrapper div.items div.item div.amountpick > button.minus");
let plus = document.querySelectorAll("section.payment div.cart-wrapper div.items div.item div.amountpick > button.plus");


// Interaction and amount validate ..............................

// Find items prices outputs
const itemsPrices = document.querySelectorAll("section.payment div.cart-wrapper div.items div.item h3.price");

// Find cartSubtotal
const cartSubtotal = document.querySelector("section.payment form.manage div.checkout div.subtotal span.price");

// Find cartTotal
const cartTotal = document.querySelector("section.payment form.manage div.checkout div.total span.price");
...
// Find shipping
const shipping = document.querySelectorAll("form.manage div.shipping ul.radios li input");
...
(function () {
	...
	// Find items
	const items = document.querySelectorAll("section.payment div.items div.item");

	// Find their delete buttons
	const itemsDeletes = document.querySelectorAll("section.payment div.cart-wrapper div.items div.item div.delete button");
